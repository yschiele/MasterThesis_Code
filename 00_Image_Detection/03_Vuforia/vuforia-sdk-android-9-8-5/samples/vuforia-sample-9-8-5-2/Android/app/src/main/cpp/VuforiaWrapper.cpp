...
Java_com_vuforia_engine_NativeSample_VuforiaActivity_initAR(
    JNIEnv *env,
    jobject /* this */,
    jobject activity,
...
Java_com_vuforia_engine_NativeSample_VuforiaActivity_startAR(
        JNIEnv *env,
        jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_pauseAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.pauseAR();
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_resumeAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.resumeAR();
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_stopAR(
    JNIEnv *env,
    jobject /* this */)
{
    controller.stopAR();
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_deinitAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.deinitAR();
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_cameraPerformAutoFocus(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_cameraRestoreAutoFocus(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_initRendering(
        JNIEnv *env,
        jobject /* this */)
{
    // Define clear color
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_setTextures(
    JNIEnv *env,
    jobject /* this */,
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_deinitRendering(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT jboolean JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_configureRendering(
        JNIEnv *env,
        jobject /* this */,
...
JNIEXPORT jboolean JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_renderFrame(
        JNIEnv *env,
        jobject /* this */)
{
...
Java_com_vuforia_engine_NativeSample_VuforiaActivity_00024Companion_getImageTargetId(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT jint JNICALL
Java_com_vuforia_engine_NativeSample_VuforiaActivity_00024Companion_getModelTargetId(
    JNIEnv *env,
    jobject /* this */)
{
