...
public class AugmentedImageActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    for (AugmentedImage augmentedImage : updatedAugmentedImages) {
      switch (augmentedImage.getTrackingState()) {
        case PAUSED:
          ...
          // but not yet tracked.
          String text = String.format("Detected Image: " + augmentedImage.getName());
        ...
        case STOPPED:
          ...
          String text_stopped = String.format("TRACKING STOPPED!");
          messageSnackbarHelper.showMessage(this, text_stopped);
          break;
  ...
  private boolean setupAugmentedImageDatabase(Config config) {
    ...
    if (useSingleImage) {
      ...
      augmentedImageDatabase.addImage("puppy.jpg", augmentedImageBitmap);
    } else {
  ...
  private Bitmap loadAugmentedImageBitmap() {
    ...
    try (InputStream is = getAssets().open("puppy.jpg")) {
